...
var setRequireSimplifyTests = []struct {
	desc string
	in   string
	mods []require
	out  string
...
func TestSetRequireAtMostTwo(t *testing.T) {
	for _, tt := range setRequireSimplifyTests {
		t.Run(tt.desc, func(t *testing.T) {
			var mods []*Require
			for _, mod := range tt.mods {
				mods = append(mods, &Require{
